...
class SuperColorMultiServer:
    ...
    def get_client(self):
        ...
        self.client_list.append([connection, "", ""])   # each element of the client list is a list of connection,
                                                            # received message and the broadcast color of the connection
...
def main():
    ...
    # server.get_client()
    # while True:
    #     readable, writable, exceptional = select.select([0, ], [1, ], [])
    #     for s in readable:
    #         while True:
    #             server.get_client()
    #
