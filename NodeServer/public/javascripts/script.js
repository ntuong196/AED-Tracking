...
function initMap() {
    ...
    autocomplete.addListener('place_changed', function() {
        ...
        document.getElementById('location').innerHTML = "Address: " + place.formatted_address ;
        document.getElementById('latlon').innerHTML = "Latitude, longitude: " + place.geometry.location.lat()+ ", " +  place.geometry.location.lng();


        if ((place.geometry.location.lat()== -27.477357) && (place.geometry.location.lng() ==153.028415)) {
        ...
        if ((place.geometry.location.lat()== -27.4509016) && (place.geometry.location.lng() ==153.01691170000004)) {
            document.getElementById("status","statusGen").style.visibility = "visible";
